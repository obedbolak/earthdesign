        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              ...
              >
                Get the latest properties and real estate news delivered to your
                inbox
              </motion.p>
            </div>
            <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
            ...
            >
              ...
              >
                Your trusted partner for luxury villas, modern apartments,
                commercial developments, and prime land across Cameroon. We
                bring your property dreams to life with excellence and
                integrity.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p style={{ color: COLORS.gray[400] }} className="text-sm">
                      Carrefour T.K.C, Yaoundé, Cameroon
                    </p>
                  </div>
                </div>
