...
// Optional generic mapper (kept for future use or other projects)
// Currently not used in your import config, but harmless to keep
export const mapRow = <T extends { id: number }>(
  ...
  // Build object dynamically – useful for generic cases
